...
#gui.show_visit_proportions(an.most_visited(story, stores), paths_per_reading, 'tory', story)
#gui.show_visit_proportions(None, paths_per_reading, 'tory', story)
#gui.show_text_info(story, paths_per_reading, stores, sim_store, log_store)
#gui.show_path_comparison(story, sim_store, log_store)
